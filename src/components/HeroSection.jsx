        ...
        <div className="container mx-auto flex px-4 sm:px-8 lg:px-14 py-12 lg:py-32 flex-col lg:flex-row items-center justify-between lg:mt-0 mt-14">
          <div className="lg:w-1/2 w-full flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0">
            ...
            <p
              ...
              data-aos-delay="600"
            >
              I'm an aspiring backend developer from Nepal passionate about
              building scalable and efficient server-side applications. I focus
              on clean architectures, reliable APIs, and continuous growth as a
              developer. I'm willing to learn new technologies and contribute to
              impactful projects. Let's connect and create something amazing
              together!
            </p>
            ...
            <div className="w-full pt-4 sm:pt-6">
              ...
              >
                ...
                >
                  <button
                    className={`w-full sm:w-auto inline-flex items-center justify-center ${theme.buttonSecondary} py-3 px-6 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)] rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform cursor-pointer`}
                  >
