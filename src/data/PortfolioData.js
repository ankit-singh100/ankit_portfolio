...
export const ABOUT = {
  ...
  focus:
    "Right now, I'm focused on mastering REST APIs, database design, anf writing clean, maintainable server-side code while building pratical projects that solve real problems.",
};
